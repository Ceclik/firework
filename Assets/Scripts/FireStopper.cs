...
public class FireStopper : MonoBehaviour
{
    ...
    public void StopFireStopping()
    {
        ...
        if (lightning != null && lightning.activeSelf) lightning.SetActive(false);
        if (danger != null && danger.activeSelf) danger.SetActive(false);
    }
    ...
    private IEnumerator StartAudio()
    {
        ...
        //UnityEngine.Debug.Log("startsound");
        ...
        var n = Random.Range(0, soundLoops.Length);
        ...
        while (_pSystem.isEmitting)
        {
            ...
            var newN = n;
            while (n == newN) n = Random.Range(0, soundLoops.Length);
        }

        //UnityEngine.Debug.Log("endsound");
