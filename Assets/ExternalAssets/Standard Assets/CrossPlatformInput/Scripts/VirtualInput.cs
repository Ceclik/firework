...
namespace ExternalAssets.Standard_Assets.CrossPlatformInput.Scripts
{
    public abstract class VirtualInput
    {
        ...
        protected Dictionary<string, CrossPlatformInputManager.VirtualAxis> m_VirtualAxes = new();

        // Dictionary to store the name relating to the virtual axes
        protected Dictionary<string, CrossPlatformInputManager.VirtualButton> m_VirtualButtons = new();
